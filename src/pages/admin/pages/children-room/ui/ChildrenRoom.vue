<template>
  <div>
    ...
    <form @submit.prevent="onSubmit">
      ...
      <InputChoiceFile label="Главная картинка" label-text="Додати головну картинку" />
